...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	meanSpeedInMps := w.meanSpeed() * KmHInMsec // перевод скорости в м/с
	return ((CaloriesWeightMultiplier*w.Weight + math.Pow(meanSpeedInMps, 2)/(w.Height/CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
